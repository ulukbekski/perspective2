...
// import vidSingapore from '../assets/all-images/USA.mp4'
          ...
          <Row>
            <Col lg="8" md="8">
              <div className="blog__details">
                ...
                <video className="video" autoPlay muted loop src={blog.vidUrl}></video>
                </div>
...
{/* 
            ...
            <Col lg="4" md="4">
              <div className="recent__post mb-4">
                <h5 className=" fw-bold">Обучение и Путешествие</h5>
              </div>
              {blogData.map((item) => (
